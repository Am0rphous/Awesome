...
Reduce complexity/avoid feature bloat <br>
Embrace unit testing <br>
Code readability: test with unexperienced programmers <br>
...
- [vcard-studio](https://snapcraft.io/vcard-studio) - A snap package for editing vCard file format
  ...
  - [Thunderbird](https://www.thunderbird.net)
    - [Thunderbird Extensions](ps://addons.thunderbird.net)
      ...
      - [Thunderbird User.JS](https://github.com/HorlogeSkynet/thunderbird-user.js) - Thunderbird privacy, security and anti-fingerprinting: a comprehensive user.js template for configuration and hardening.
      - [TorBirdy](https://addons.thunderbird.net/nb-NO/thunderbird/addon/torbirdy/) - This extension configures Thunderbird to make connections over the Tor anonymity network.
  ...
  - GitHub
    ...
    - [Git-alerts](https://github.com/boringtools/git-alerts) - Tool to detect and monitor GitHub org users' public repositories for secrets and sensitive files
...
- [xlivebg](https://github.com/jtsiomb/xlivebg) - Live wallpapers for the X window system.
  ...
  - [Dotfiles](https://github.com/EbadShelby/dotfiles) - Fedora Workstation/GNOME setup🐧
...
- [Wing](https://github.com/kbrsh/wing) - A beautiful CSS framework designed for minimalists [kbrsh.github.io](https://kbrsh.github.io/wing/).
  ...
  - [Gnome-shell-extension-appindicator](https://github.com/ubuntu/gnome-shell-extension-appindicator) - Adds KStatusNotifierItem support to the Shell. [extensions.gnome.org/extension/615/appindicator-support](https://extensions.gnome.org/extension/615/appindicator-support/)
  ...
  - [How-to-be-a-great-programmer](https://github.com/WeeJeWel/how-to-be-a-great-programmer) - null
  ...
  - [Yaklang](https://github.com/yaklang/yaklang) - A programming language exclusively designed for cybersecurity
    ...
    - [CakePHP officiall repo](https://github.com/cakephp/cakephp) - CakePHP: The Rapid Development Framework for PHP - Official Repository.
...
## Hardware
- [https://www.displayspecifications.com](https://www.displayspecifications.com) - compare displays
...
- [Wwmark](https://github.com/mylamour/Wwmark) - Watermark Swiss Army Knife.
  ...
  ### Image and pictures
  - [AffinityOnLinux](https://github.com/seapear/AffinityOnLinux) - A repository that helps users get affinity software working on GNU/Linux 🐧 [https://www.affinity.studio/](https://www.affinity.studio/)
  ...
  - [Plex](https://www.plex.tv/) -  closed source media server + desktop application. [plex.tv](https://www.plex.tv/)
    ...
    - [overseerr](https://overseerr.dev/)
      - https://docs.overseerr.dev/getting-started/installation#docker-cli
      - Behind ngix proxy: https://github.com/sct/overseerr/blob/develop/docs/extending-overseerr/reverse-proxy.md
  ...
  - [Snapcast](https://github.com/badaix/snapcast) - Snapcast is a multiroom client-server audio player, where all clients are time synchronized with the server to play perfectly synced audio. [Homepage Snapcast](https://mjaggard.github.io/snapcast/)
    ...
    - Sound Recorders
      - [Sound Recorder](https://flathub.org/en/apps/org.gnome.SoundRecorder) `flatpak install flathub org.gnome.SoundRecorder`
...
- [Taskade](https://taskade.com) - Collaborative To-Do Lists, Mind Maps, and Notes.
...
that works on top of your local folder of plain text files. [github](https://github.com/obsidianmd/obsidian-releases)
    - [Plugin - Charts ](https://charts.phib.ro/Meta/Charts/Charts+Documentation) - let's you create interactive Charts inside Obsidian - [source](https://github.com/phibr0/obsidian-charts)
    - [plugin - Mind Map](https://github.com/lynchjames/obsidian-mind-map)
