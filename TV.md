...
- [Moonlight-tv](https://github.com/mariotaku/moonlight-tv) - Lightweight NVIDIA GameStream Client, for LG webOS TV and embedded devices like Raspberry Pi.
  - Open `m3u` files in e.g. vlc player: https://github.com/iptv-org/iptv/blob/master/PLAYLISTS.md
...
- [TizenTubeCobalt](https://github.com/reisxd/TizenTubeCobalt) - Experience TizenTube on other devices that are not Tizen. [https://tizentube.app/](https://tizentube.app/)
